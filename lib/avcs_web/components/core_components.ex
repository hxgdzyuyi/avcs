defmodule AvcsWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AvcsWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AvcsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AvcsWeb.Gettext, "errors", msg, opts)
    end
  end
