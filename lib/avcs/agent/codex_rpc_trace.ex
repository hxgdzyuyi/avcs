defmodule Avcs.Agent.CodexRpcTrace do
  ...
  def append_outbound(project, context, message, meta \\ %{}) do
    ...
    append_event(project, context, %{
      ...
      agent_harness: "codex",
      provider: "codex",
      remote_thread_id: ids.codex_thread_id,
      remote_turn_id: ids.codex_turn_id,
      remote_item_id: ids.codex_item_id,
      status: "sent",
  ...
  def append_decode_failed(project, context, line, reason) do
    ...
    append_event(project, context, %{
      ...
      agent_harness: "codex",
      provider: "codex",
      remote_thread_id: context.codex_thread_id,
      remote_turn_id: context.codex_turn_id,
      remote_item_id: context.codex_item_id,
      status: "error",
      payload: %{
        direction: "inbound",
        transport: @transport,
